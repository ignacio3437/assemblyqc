...
- `HYh1h2_Chr01_6000000_6015000.bam:` Obtained by mapping `fastq` to `fasta` using bwa-mem (`-5SP`)
- `HYh1h2_Chr01_6000000_6015000.fasta.fai:` Obtained from the `fasta` using `samtools view`
- `HYh1h2_Chr01_6000000_6015000.agp` AGP obtained from `fasta` using `makeAgpFromFasta.py`
