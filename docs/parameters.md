...
| `ncbi_fcs_adaptor_empire`      | Empire for NCBI FCS Adaptor checking                                          | `string`  |         |          |        |
...
| `hic_map_combinations`  | Space separated tags for HiC map construction, e.g. "tag1 tag2:tag3". In "tag2:tag3", "tag2" is the query in refsort. null implies separate map for each input |
| assembly.               | `string`                                                                                                                                                       |           |                                                   |          |
...
| `synteny_mummer_plot_type`         | Synteny plot type from Mummer alignments                                                                                                                   | `string`  | both    |          |        |
...
| `synteny_plotsr_assembly_order`    | The order in which the assemblies should be compared, provided as space separated string of assembly tags. If absent, assemblies are ordered by their tags |
...
| `mapback_clair3_platform`   | Platform for Clair3 model selection                                                 | `string`  |         |          |        |
